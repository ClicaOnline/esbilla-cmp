export const ca = {
  ...
  'saas.why.price.desc': 'El preu més competitiu del mercat. Sense tarifes abusives per sessió.',
  ...
  // Waitlist
  'waitlist.hero.title': 'Uneix-te a la Llista d\'Espera',
  'waitlist.hero.subtitle': 'Esbilla CMP estarà llest aviat. Registra\'t ara i estaràs entre els primers a utilitzar la millor plataforma de gestió de consentiment.',
  'waitlist.form.title': 'Formulari d\'Accés Anticipat',
  'waitlist.form.name.label': 'Nom Complet',
  'waitlist.form.name.placeholder': 'El teu nom',
  'waitlist.form.email.label': 'Correu Electrònic',
  'waitlist.form.email.placeholder': 'email@exemple.com',
  'waitlist.form.company.label': 'Empresa / Projecte',
  'waitlist.form.company.placeholder': 'Nom de l\'empresa o projecte',
  'waitlist.form.domain.label': 'Domini / Web',
  'waitlist.form.domain.placeholder': 'https://www.exemple.com',
  'waitlist.form.details.label': 'Com penses utilitzar Esbilla CMP?',
  'waitlist.form.details.placeholder': 'Explica\'ns sobre el teu cas d\'ús, volum de trànsit, etc.',
  'waitlist.form.phone.label': 'Telèfon (opcional)',
  'waitlist.form.phone.placeholder': '+34 666 000 000',
  'waitlist.form.consent': 'Accepto l\'{link} per al tractament de dades',
  'waitlist.form.consent.link': 'Avís Legal',
  'waitlist.form.submit': 'Unir-se a la Llista',
  'waitlist.form.submitting': 'Enviant...',
  'waitlist.success.title': 'Gràcies!',
  'waitlist.success.message': 'Hem rebut la teva sol·licitud. Contactarem amb tu aviat.',
  'waitlist.error.title': 'Error',
  'waitlist.error.message': 'Hi ha hagut un problema. Si us plau, torna-ho a provar.',
  'waitlist.legal.title': 'Avís Legal - Tractament de Dades',
  'waitlist.legal.intro': 'En enviar aquest formulari, proporciones les teves dades personals a Esbilla CMP amb la següent finalitat:',
  'waitlist.legal.purpose.title': '📋 Finalitat del Tractament',
  'waitlist.legal.purpose.text': 'Gestió de la llista d\'espera per a l\'accés anticipat a la plataforma Esbilla CMP i comunicacions relacionades amb el llançament del servei.',
  'waitlist.legal.legal.title': '⚖️ Base Legal',
  'waitlist.legal.legal.text': 'Consentiment de l\'interessat (RGPD Art. 6.1.a). Les teves dades només es processaran si ho acceptes expressament.',
  'waitlist.legal.data.title': '🔒 Dades Recollides',
  'waitlist.legal.data.text': 'Nom, correu, empresa/projecte, domini, detalls del cas d\'ús, telèfon (opcional), data de sol·licitud.',
  'waitlist.legal.retention.title': '📅 Període de Conservació',
  'waitlist.legal.retention.text': 'Les dades es conservaran fins al llançament de la plataforma o fins que sol·licitis la seva eliminació.',
  'waitlist.legal.rights.title': '✅ Els Teus Drets',
  'waitlist.legal.rights.text': 'Tens dret d\'accés, rectificació, eliminació, limitació, portabilitat i oposició. Per exercir-los, contacta: hola@esbilla.com',
  'waitlist.legal.close': 'Tancar'
