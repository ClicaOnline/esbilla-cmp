...
Write-Info "   1. Anadir dominios de clientes con: .\add-client-domain.ps1 -Domain gtm.cliente.com"
Write-Info "   2. Configurar gtmGatewayDomain en Dashboard para cada site"
Write-Info "   3. Los certificados SSL se provisionaran automáticamente (15-30 min)"
Write-Info ""
