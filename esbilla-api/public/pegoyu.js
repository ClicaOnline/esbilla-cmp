  ...
  function toggleSettings() {
    ...
    settingsPanel.innerHTML = `
      ...
      <div class="esbilla-actions" style="margin-top: 20px;">
        <button id="esbilla-btn-save" class="esbilla-btn esbilla-btn-primary">${t.saveSettings || 'Guardar'}</button>
      </div>
      ...
      <div id="esbilla-banner">
        <div class="esbilla-inner">
          ...
          <div class="esbilla-actions">
            ...
            <button id="esbilla-btn-reject" class="esbilla-btn esbilla-btn-primary-outline">{{reject}}</button>
            <button id="esbilla-btn-settings" class="esbilla-btn esbilla-btn-link">{{settings}}</button>
          </div>
        </div>
      </div>
    `;
